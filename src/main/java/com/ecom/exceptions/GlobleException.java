...
public class GlobleException {
	...
	public ResponseEntity<ErrorDetails> badCredentialExceptionHandler(BadCredentialsException e, WebRequest req){
	...
	public ResponseEntity<ErrorDetails> otherRuntimeExceptionHandler(Exception e, WebRequest req){
		ErrorDetails error=new ErrorDetails(e.getMessage(),req.getDescription(false),LocalDateTime.now());
