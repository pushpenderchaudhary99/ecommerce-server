...
public class Product {
	...
	public Product(String title, String description, int price, int discountedPrice, int discountPersent,
			int quantity, String brand, String color, Set<Size> sizes, String imageUrl,Category category,LocalDateTime createdAt) {
		super();
		this.title = title;
